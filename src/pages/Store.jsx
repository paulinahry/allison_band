      ...
      <div className="flex flex-col justify-center items-center relative mb-20">
        ...
        >
          <h1 className="text-5xl md:text-6xl text-center font-mono z-30 mt-8 text-detailsRed">
            <span className="uppercase font-black text-details">Touch</span>{' '}
            <span className="italic font-thin text-yellowish/40">the </span>
            <span className="italic font-thin text-yellowish">music</span>
          </h1>
